...
static char		*sizemallocstr(char *str, unsigned long long n, unsigned int base)
{
	int i;
...
static void	nbr_to_str(char *str, unsigned int *i,unsigned long long n, unsigned int base)
{
	if (n >= base)
	{
